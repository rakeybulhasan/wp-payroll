            ...
            <div id="company-locations">
                ...
                <div id="company-locations-inside" class="printableArea" style="clear: both;">
                    ...
                    ?>
                        ...
                        $payCalendarRunsMethod = $payCalendarRunObj->generatePaySlipForReport($employee_id,$from_date,$to_date);
                        ?>
                    ...
                    if($payCalendarRunsMethod){
                        ...
                        foreach ($paycalenderChunk as $payCalendarRuns){
                            ...
                            foreach ($payCalendarRuns as $payCalendarRun){
                                ...
                                <table class="table <?php echo $i%3==0?'even':'odd';?> <?php echo $i==1?'first_table':'';?>" style="border-bottom: 2px dotted black">
                                    ...
                                    <tr>
                                        <td style="padding: inherit" colspan="3">
                                            ...
                                            <table border="1" style="margin-bottom: 0;background-color: inherit" class="table pay_info" width="100%">
                                                <thead>
                                                <tr>
                                                ...
                                                <?php if($payCalendarRun->payment_type!='BONUS_PAYMENT'){?>
                                                    <tr>
                                                        <td style="text-align: right; padding-right: 10px" colspan="<?php echo count($allowances)+3;?>">Balance Advance Payment</td>
                                                        <td colspan="<?php echo count($deductions)+4;?>">
                                                            <?php
                                                ...
                                                <?php if (!empty($payCalendarRun->allowance_description) || !empty($payCalendarRun->deduction_description)){?>
                                                    <tr>
                                                        <td style="text-align: center; padding-right: 10px" colspan="<?php echo count($allowances)+3;?>"><?php echo $payCalendarRun->allowance_description;?></td>
                                                        <td colspan="<?php echo count($deductions)+4;?>"><?php echo $payCalendarRun->deduction_description;?>
                                                        </td>
                                                    </tr>
                                                <?php }?>
                                            </table>
                                    ...
                                    <tr>
                                        <td style="padding-top: 35px; vertical-align: bottom">
                                            <div style="border: 1px solid #000; height: 55px; width: 27%; text-align: center;vertical-align: middle;padding-top: 6%;margin-left: 25px">Stamp</div>
