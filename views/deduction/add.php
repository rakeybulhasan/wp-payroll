<div class="wrap rbs rbs-company-single">
    <h2><?php _e( 'Add New Deduction', 'rbs-erp' ); ?></h2>

    <?php

    if (isset($_GET['status'])&& $_GET['status'] == 'submitted' ) {
        erp_html_show_notice( __( 'Deduction has been created successfully.', 'rbs-erp' ) );
                        ...
                        <div class="submitbox" id="submitbox">
                            <div id="major-publishing-actions">
                                ...
                                <div id="publishing-action">
                                    ...
                                    <input type="hidden" name="rbs-erp-action" value="deduction_new">
                                    <input type="hidden" name="id" value="">
                                    <input type="hidden" name="exists_deduction_name" value="">
